...
import { CatalogPriceBootstrap } from "./CartContext";
...
import type { PriceMap } from "@/lib/store-products";
...
export function LandingStore({
  ...
  return (
    <LandingBootProvider>
      <CatalogPriceBootstrap prices={initialPrices} />
      <div className="relative min-h-screen overflow-x-clip bg-background pb-28">
        ...
        <main className="relative z-10">
          ...
          <div className="container space-y-20 pb-16 pt-4 md:space-y-28">
            <ProductSection catalogProducts={catalogProducts} />
            <IncludedSection />
            <SocialMediaSection />
              ...
              <div className="rounded-3xl border bg-card/70 p-8 backdrop-blur md:p-10">
                ...
                <ol className="mt-6 grid gap-4 md:grid-cols-3">
                  {[
                    {
                      step: "1",
                      title: "Elegí modelo y cantidad",
                      desc: "Tarjeta blanca o negra. Sumá las que necesites al carrito.",
                    },
                    {
                      step: "2",
                      title: "Pago seguro con Mercado Pago",
                      desc: "Abonás con tarjeta, débito o dinero en cuenta en segundos.",
                    },
                    {
                      step: "3",
                      title: "Configurá tu perfil",
                      desc: "Completá tu identidad digital en el wizard y mandamos a fabricar tu tarjeta.",
                    },
                  ].map((item) => (
